...
const WishlistPage = () => {
  ...
  if (wishlistState.items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Tu lista de deseos está vacía</h2>
        <p className="text-gray-600">Agrega productos a tu lista de deseos para guardarlos para más tarde.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h2 className="text-3xl font-bold text-gray-900 mb-8">Mi Lista de Deseos</h2>
